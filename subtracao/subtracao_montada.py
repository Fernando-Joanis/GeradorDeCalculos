...
print('Gerador de Calculos Matematicos (SUBTRAÇÃO)')
...
class PDF(FPDF):
    def header(self):
        ...
        self.cell(0, 1.5, 'Gerador de calculos Matemáticos - Subtração', border=False, ln=True, align='R')
...
pdf.output('subtracao_montada_1.pdf')
